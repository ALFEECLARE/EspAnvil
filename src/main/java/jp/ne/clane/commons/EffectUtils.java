...
public class EffectUtils {
	...
	private static StringBuilder getEffectDescribeTextCore(MobEffectInstance effectIns) {
		...
		answer.append(effectIns.getEffect().getDisplayName().getString()).append(effectIns.getAmplifier() > 0 ? Component.translatable("enchantment.level." + (effectIns.getAmplifier() + 1)).getString() : "")
